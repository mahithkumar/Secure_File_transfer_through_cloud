...
function privMenu() {
	...
	var button71 = document.getElementById('uploadkeySubmit');
	...
	var button70 = document.getElementById('downloadkeyButton');
    searchText.style.display = 'none';
    searchButton.style.display = 'none';
    downloadButton.style.display = 'none';
	button70.style.display = 'none';
...
function uploadScreen() {
	...
	button71.style.display = 'inline-block';
...
function downloadScreen() {
    ...
    button6.style.display = 'inline-block';
	button70.style.display = 'inline-block';
...
function logOut() {
    ...
    document.getElementById("statusText").innerHTML = "Secure File Transfer";
    document.getElementById("subText").innerHTML = "18BIT0076 18BIT0100";
}
...
function uploadkeyClick() {
    var file = document.getElementById('fileNameStr').value;
	eel.keyencrypt(file)
    eel.uploadFile(file);
	eel.keydecryptafterupload(file)
